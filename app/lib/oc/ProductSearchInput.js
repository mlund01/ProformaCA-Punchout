/**
 * Created by mirandaposthumus on 6/24/15.
 */
...
function productsearchinput() {
    ...
    function searchTemplate() {
        return [
            ...
            '<input type="text" class="form-control" style="background-color: #E0E4E5; border: none; color: #58676d;" ng-model="productSearchTerm"/>',
            '<i class="fa fa-search" style="color: #58676D"></i>',
...
function productsearchinputnav() {
    ...
    function searchNavTemplate() {
        return [
            ...
            '<input type="text" class="form-control" ng-model="productSearchTerm"/>',
